...
//}
//
//class SignalFollowerActor(context: ActorContext[BotMessage]) extends AbstractBehavior[BotMessage](context) {
...
//
//  var quotesFetcherRef: ActorRef[BotMessage] = null
//  var tradingActorRef: ActorRef[BotMessage] = null
...
//    message match
//      case FollowSignalMessage(receivedSignal: Signal, fetcherRef: ActorRef[BotMessage], tradingRef: ActorRef[BotMessage]) =>
