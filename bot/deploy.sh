...
ssh -i ~/.ssh/trading-bot-ec2.pem $EC2_URL "sudo /var/bot/kill_me.sh" && ssh -i ~/.ssh/trading-bot-ec2.pem $EC2_URL 'java -jar /var/bot/trading-bot-assembly-0.1.0-SNAPSHOT.jar &'
