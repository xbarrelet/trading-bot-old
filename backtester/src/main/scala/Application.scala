...
//  val backtestedStrategy: List[String] = List("SimpleStrategy", "LeveragedSimpleStrategy", "TrailingLossSimpleStrategy")
  val backtestedStrategy: List[String] = List("TrailingLossSimpleStrategy")
